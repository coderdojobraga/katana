defmodule Katana.NinjasTest do
  ...
  describe "ninjas" do
    ...
    @invalid_attrs %{
      full_name: nil,
      birth_date: nil,
      has_attended_before: nil,
      number_of_sessions: nil,
      coderdojo_experience_description: nil,
      programming_experience_description: nil,
    ...
    test "update_ninja/2 with valid data updates the ninja" do
      ...
      update_attrs = %{
        ...
        number_of_sessions: 43,
        coderdojo_experience_description: "some updated coderdojo_experience_description",
        programming_experience_description: "some updated programming_experience_description",
        has_medical_condition: false,
        medical_condition_details: "some updated medical_condition_details",
      ...
      assert ninja.coderdojo_experience_description ==
               "some updated coderdojo_experience_description"

      assert ninja.programming_experience_description ==
               "some updated programming_experience_description"
